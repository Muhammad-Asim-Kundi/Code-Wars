...
//letter (direction) and you know it takes you one minute to traverse one city block, so create a function 
//that will return true if the walk the app gives you will take you exactly ten minutes (you don't want to be 
...
function isValidWalk(walk) {
    ...
    //vertical & horizontal position movement tracking
    let vertical = 0
    let horizental = 0
    
    //loop through walk steps
    for(let step of walk){
      //switch checks and updates horizontal & vertical position accordingly
      switch(step){
          case 'n':
          vertical++
          break
    ...
    //checks if both vertical and horizontal are back to zero(starting point)
